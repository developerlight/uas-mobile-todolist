import { Button, FlatList, Image, Modal, Pressable, StatusBar, StyleSheet, Text, TextInput, View } from "react-native";
...
const Riwayat = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const filteredData = await tasks.filter(item => parseDate(item.date) < today);
